...
public class userService {
    ...
    public userService(String emails, String passwords)
    {
        ...
        String[][] data = 
        { 
            {"FikiRiloPambudikelompok54@gmail.com", "12345", "supedAdmin"},
            {"ArielJonesDekockkelompok54@gmail.com", "12345", "user"} 
        };
        String[][] histories = 
        {
            {"FikiRiloPambudikelompok54@gmail.com", "Fisika Dasar", "Dasar Komputer dan Pemrograman", "26-04-2020"},
            {"ArielJonesDekockkelompok54@gmail.com", "Dasar Komputer dan Pemrograman", "Konsep Jaringan Komputer", "26-04-2020"}
        };
        this.data = data;
